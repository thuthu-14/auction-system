...
public class AuctionDetailController {
    ...
    @FXML private void handleDecreaseBid() {
        try {
            ...
            if (currentBid - minimumBidIncrement >= minAllowedBid) {
                ...
                bidAmountField.setText(String.valueOf((long) currentBid));
            }
        } catch (Exception e) {
            bidAmountField.setText(String.valueOf((long)(currentPrice + minimumBidIncrement)));
        }
    }
    ...
    private String formatPlainNumber(double amount) { return String.valueOf((long)amount); }
