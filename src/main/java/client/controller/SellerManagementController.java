...
public class SellerManagementController {
    ...
    private void setupTableColumns() {
        ...
        // --- SỬA LỖI LINK CỘT THỜI GIAN VỚI PROPERTY TỰ ĐỘNG CẬP NHẬT ---
    ...
    private String formatVnd(long a) { return String.format("%,d d", a).replace(',', '.'); }

    // Đã bỏ hàm formatTime() thủ công và chuyển sang dùng DateTimeUtil
    ...
    public static class AuctionItem {
        ...
        private final SimpleStringProperty timeLeftStr = new SimpleStringProperty(""); // Biến giữ thời gian để format
