...
public class NotificationClientService {
    ...
    private static final Map<String, NotificationPresentation> PRESENTATIONS = Map.of(
            ...
            "AUCTION_FINISHED", new NotificationPresentation("F", "-fx-background-color: #fef3c7; -fx-background-radius: 30;", "#92400e", "#1a1a1a", DEFAULT_BUTTON_STYLE, DEFAULT_UNREAD_CONTAINER_STYLE, NotificationAction.AUCTION_HISTORY, NotificationAction.SELLER_MANAGE_AUCTIONS, Set.of(NotificationScope.BIDDER, NotificationScope.SELLER)),
            "AUCTION_CANCELLED", new NotificationPresentation("X", "-fx-background-color: #fee2e2; -fx-background-radius: 30;", "#b91c1c", "#991b1b", "-fx-background-color: #dc2626; -fx-text-fill: white; -fx-background-radius: 20; -fx-cursor: hand; -fx-padding: 8 20 8 20;", "-fx-background-color: white; -fx-background-radius: 15; -fx-border-color: #f87171; -fx-border-radius: 15; -fx-border-width: 2; -fx-padding: 20; -fx-effect: dropshadow(three-pass-box, rgba(248,113,113,0.18), 15, 0, 0, 5);", NotificationAction.WALLET, NotificationAction.SELLER_MANAGE_AUCTIONS, Set.of(NotificationScope.BIDDER, NotificationScope.SELLER)),
