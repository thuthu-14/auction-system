...
|:--------------------| :--- |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :--- |
| **Phạm Yến Nhi**    | Xây dựng Hạ tầng & Đa luồng | - Xây dựng các hàm tiện ích dùng chung (common/*, util/*).<br>- Cấu hình quản lý luồng xử lý (ThreadPoolManager.java).<br>- Cơ chế khóa đồng bộ dữ liệu (SyncLockManager.java), network.                           | Đảm bảo hệ thống vận hành ổn định, không bị xung đột khi nhiều người cùng đấu giá một lúc. |
